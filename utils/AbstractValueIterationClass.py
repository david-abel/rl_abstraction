...
from simple_rl.abstraction import ActionAbstraction
from simple_rl.abstraction import StateAbstraction
from simple_rl.abstraction.abstr_mdp.abstr_mdp_funcs import make_abstr_mdp
...
class AbstractValueIteration(ValueIteration):
    ...
    def __init__(self, ground_mdp, state_abstr=None, action_abstr=None, sample_rate=10, delta=0.001, max_iterations=1000):
        ...
        self.state_abstr = state_abstr if state_abstr not in [[], None] else StateAbstraction()
        self.action_abstr = action_abstr if action_abstr not in [[], None] else ActionAbstraction(prim_actions=ground_mdp.get_actions())
