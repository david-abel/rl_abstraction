...
class HierarchicalValueIteration(ValueIteration):
    ''' HierarchicalValueIteration: Runs Value Iteration using a hierarchical agent. '''

    def __init__(self, ground_mdp, hierarchical_agent, sample_rate=1, delta=0.001, max_iterations=1000):
        '''
        Args:
            ground_mdp (MDP)
        ...
        '''
        ValueIteration.__init__(self, ground_mdp, name="hierarch-" + str(ground_mdp), delta=delta, max_iterations=max_iterations, sample_rate=sample_rate)
