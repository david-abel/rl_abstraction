...
class DynamicHierarchyAgent(HierarchyAgent):
    ...
    def __init__(self, SubAgentClass, sa_stack, aa_stack, cur_level=0, name_ext="", auo=30):
        '''
        Args:
        ...
        '''
        HierarchyAgent.__init__(self, SubAgentClass, sa_stack, aa_stack, cur_level=0, name_ext=name_ext)
        self.num_switches = 0
        self.num_actions_since_open = 0
        self.actions_until_open = auo
    ...
    def act(self, ground_state, reward):
        ...
        if self.num_actions_since_open > self.actions_until_open and not self.action_abstr_stack.is_next_step_continuing_option(ground_state):
            ...
            new_level = int(not(bool(self.cur_level)))
    ...
    def _compute_max_v_hat_level(self, ground_state):
        ...
        if self.cur_level == 1:
            ...
            for lvl in xrange(self.get_num_levels() + 1):
                ...
                # print lvl, v_hat
                change_cost = 0.0009 * int(lvl != self.cur_level)
